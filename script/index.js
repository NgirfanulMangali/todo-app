...
document.getElementById("input").addEventListener('keydown', (e) => {
    ...
    if (e.key === 'Enter') {
        ...
        saveData.forEach((item) => {
            listResult.innerHTML += `<div class="w-[450px] h-[60px]     bg-Very-Dark-Grayish-Blue-alt flex px-4 break-all overflow-auto border-b-1 border-Dark-Grayish-Blue">
                                <div class="mt-3">
        ...
        <div class="w-[450px] h-[60px] bg-Very-Dark-Grayish-Blue-alt  flex justify-between px-4 rounded-b-lg text-Dark-Grayish-Blue ">
                            <p class="mt-4">5 items left</p>
                            <button class="cursor-pointer"><p>Clear Completed</p></button>
                        </div>
